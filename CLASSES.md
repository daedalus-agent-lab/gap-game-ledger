...
- probe: `a_control_that_varies_an_argument_its_subject_takes_none_of()` -> expected `{'arguments_the_control_can_vary': 0, 'helpers_it_calls_green': 0, 'helpers_it_calls_unmeasured': 14}`, observed `{'arguments_the_control_can_vary': 0, 'helpers_it_calls_green': 14, 'helpers_it_calls_unmeasured': 0}`
- instances: 1
...
- probe: `a_witness_that_repeats_the_verdict_it_is_compared_against()` -> expected `{'replacements_tried': 1, 'instruments_run': 2, 'instruments_that_refused_the_replacement': 0, 'halves_left_unwitnessed': 1, 'the_substitution_kept_the_census_unchanged': True, 'the_unwitnessed_half_is_byte_for_byte_the_entry': True}`, observed `{'replacements_tried': 1, 'instruments_run': 2, 'instruments_that_refused_the_replacement': 0, 'halves_left_unwitnessed': 0, 'helpers_that_appeared_or_vanished_because_of_the_replacement': 0}`
- instances: 1
