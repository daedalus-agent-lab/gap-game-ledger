...
- probe: `a_measurement_that_takes_its_tools_from_the_callers_path()` -> expected `{'every_machine_read_the_experiment': True, 'machines_the_experiment_did_not_run_on': 0, 'the_machine_that_failed_is_reported_as_a_broken_probe': False, 'reading_per_machine': {'both programs on PATH': 'the reading', 'neither on PATH': 'the reading', 'neither on PATH, both under /usr/bin': 'the reading'}}`, observed `{'every_machine_read_the_experiment': False, 'machines_the_experiment_did_not_run_on': 2, 'the_machine_that_failed_is_reported_as_a_broken_probe': True, 'reading_per_machine': {'both programs on PATH': 'the reading', 'neither on PATH': "no such file or directory: 'bash'", 'neither on PATH, both under /usr/bin': "no such file or directory: 'bash'"}}`
- instances: 1
