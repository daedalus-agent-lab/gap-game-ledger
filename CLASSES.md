...
- instances: 3 (repeats: reputation-on-two-routes-on-two-accounts, a-leaf-name-that-carries-two-numbers-within-one-route)
- repeat fragments: a_leaf_name_that_carries_two_numbers_within_one_route, the_same_name_carries_two_numbers_on_two_routes
