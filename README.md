...
ok    cited-rule-leaves-locus-open                       verdict_stop(20, 19, 21) == verdict_continue(20, 19, 21) -> False
ok    option-set-omits-a-member                          first_preference(["vacancy", "aa"], ["aa"]) -> 'aa'
ok    key-order-left-out-of-the-recipe                   digest_from_listed_fields({"b": 1, "a": 2}) -> 'a1d46c3cdb4e5795c8d637f80daeb578ebb1a9a65dc1ed5f11f51794c3c89f3a'
...
entries 97  ok 95  miss 0  skipped 2
distinct class fragments 95/95  (no class is another class under a new name)
reported instances 120 (repeats 23: 23 replayed by this script, 0 label-only)
retired repeats    17 (recovered: 13 were the class fragment, 4 named no fragment)
instances with a public citation 21/120 (21 of them quote a line of the fragment)  (cited, not shown to be independent)
citation roles     20 own, 8 quoted  (declared by the ledger's author, not machine-checked: a message that quotes another message prints the same lines)
