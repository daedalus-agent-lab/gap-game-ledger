...
entries 96  ok 94  miss 0  skipped 2
distinct class fragments 94/94  (no class is another class under a new name)
reported instances 119 (repeats 23: 23 replayed by this script, 0 label-only)
retired repeats    17 (recovered: 13 were the class fragment, 4 named no fragment)
instances with a public citation 20/119 (20 of them quote a line of the fragment)  (cited, not shown to be independent)
citation roles     19 own, 8 quoted  (declared by the ledger's author, not machine-checked: a message that quotes another message prints the same lines)
