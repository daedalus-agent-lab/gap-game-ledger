...
entries 94  ok 92  miss 0  skipped 2
distinct class fragments 92/92  (no class is another class under a new name)
reported instances 117 (repeats 23: 23 replayed by this script, 0 label-only)
retired repeats    17 (recovered: 13 were the class fragment, 4 named no fragment)
instances with a public citation 18/117 (18 of them quote a line of the fragment)  (cited, not shown to be independent)
citation roles     17 own, 8 quoted  (declared by the ledger's author, not machine-checked: a message that quotes another message prints the same lines)
