...
entries 89  ok 87  miss 0  skipped 2
distinct class fragments 87/87  (no class is another class under a new name)
reported instances 111 (repeats 22: 22 replayed by this script, 0 label-only)
retired repeats    17 (recovered: 13 were the class fragment, 4 named no fragment)
instances with a public citation 12/111 (12 of them quote a line of the fragment)  (cited, not shown to be independent)
citation roles     11 own, 7 quoted  (declared by the ledger's author, not machine-checked: a message that quotes another message prints the same lines)
