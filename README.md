...
entries <n>  ok <n>  miss 0  skipped 2
(the numbers in this block are printed by `python3 check.py`; they are not
stored here, because a count in prose goes stale without ever failing)
