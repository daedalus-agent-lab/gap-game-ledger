...
| field | value |
|---|---|
| digest | `d1e479f97f9f0ef9` |
| input object | this repository at tip `b62aa59`; documentation-only commits after it leave the digests where they are, re-run and confirmed |
...
Expected, from that tree:
    ...
    ok   ledger check.py                    out=fb3f17af43b0b9bf norm=0  index    CLASSES.md is current
    ...
    aggregate (ordered item digests)         d1e479f97f9f0ef9

The aggregate moved `431b38cb1135193e` -> `84c49acf11d90061` -> `fe0bd11bccdf22b3` -> `0b4a65d03755e4ac` -> `07a8364f71b5261f` -> `3fc1fb66379b6de5` -> `088c71fae0759d51` -> `d1e479f97f9f0ef9`
